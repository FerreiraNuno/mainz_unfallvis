...
customColoringMap = {
    CONSTS.UNFALLART: {
        ...
        "1": "rgb(54, 162, 235)",   # Zusammenstoß mit anfahrendem/anhaltendem/ruhendem Fahrzeug
        "2": "rgb(255, 206, 86)",   # Zusammenstoß mit vorausfahrendem/wartendem Fahrzeug
        "3": "rgb(75, 192, 192)",   # Zusammenstoß mit seitlich in gleicher Richtung fahrendem Fahrzeug
        "4": "rgb(153, 102, 255)",  # Zusammenstoß mit entgegenkommendem Fahrzeug
        "5": "rgb(255, 159, 64)",   # Zusammenstoß mit einbiegendem/kreuzendem Fahrzeug
        "6": "rgb(201, 203, 207)",  # Zusammenstoß zwischen Fahrzeug und Fußgänger
    ...
    CONSTS.LICHTVERHAELTNISSE: {
        "0": "rgb(255, 223, 0)",   # Tageslicht (bright yellow, represents daylight)
        "1": "rgb(255, 140, 0)",   # Dämmerung (orange, represents twilight)
        "2": "rgb(50, 50, 150)"    # Dunkelheit (dark blue, represents darkness)
    },
    CONSTS.STRASSENVERHAELTNISSE: {
        "0": "rgb(34, 139, 34)",   # trocken (dry) - Green to indicate safety/stability.
        "1": "rgb(70, 130, 180)",  # nass/feucht/schlüpfrig (wet/slippery) - Blue to signify water or moisture.
        "2": "rgb(255, 250, 250)"  # winterglatt (icy) - Snowy white to represent wintery/icy conditions.
    },
    CONSTS.STRASSENART: {
        "0": "rgb(255, 69, 0)",   # Wochenende (Weekend) - Vibrant red-orange to symbolize activity and leisure.
        "1": "rgb(30, 144, 255)"  # Wochentag (Weekday) - Calm blue to represent routine and workdays.
    },
    CONSTS.TAGKATEGORIE: {
        "construction": "rgb(255, 165, 0)",    # Bauarbeiten - Orange for construction zones.
        "living_street": "rgb(50, 205, 50)",   # Verkehrsberuhigter Bereich - Green for calm residential areas.
        "motorway": "rgb(0, 0, 255)",          # Autobahn - Blue for major highways.
        "motorway_link": "rgb(0, 191, 255)",   # Autobahnanschluss - Light blue for motorway connections.
        "path": "rgb(160, 82, 45)",            # Weg - Brown for paths or footways.
        "primary": "rgb(255, 69, 0)",          # Hauptstraße - Bright red for main roads.
        "primary_link": "rgb(255, 140, 0)",    # Hauptstraßenanschluss - Orange-red for primary road links.
        "residential": "rgb(173, 216, 230)",   # Wohnstraße - Light blue for residential streets.
        "secondary": "rgb(255, 215, 0)",       # Nebenstraße - Gold for secondary roads.
        "secondary_link": "rgb(218, 165, 32)", # Nebenstraßenanschluss - Darker gold for secondary road links.
        "service": "rgb(192, 192, 192)",       # Serviceweg - Silver for service streets.
        "tertiary": "rgb(128, 128, 0)",        # Tertiärstraße - Olive for tertiary roads.
        "track": "rgb(139, 69, 19)",           # Fahrweg - Dark brown for agricultural/forestry tracks.
        "trunk": "rgb(75, 0, 130)",            # Schnellstraße - Indigo for high-speed roads.
        "trunk_link": "rgb(123, 104, 238)",    # Schnellstraßenanschluss - Purple for trunk road links.
        "unclassified": "rgb(169, 169, 169)",  # Nicht klassifiziert - Grey for unclassified roads.
    },
}
